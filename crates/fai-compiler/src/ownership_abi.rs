...
pub const HOST_IMPORTS: &[HostImportRow] = &[
    ...
    HostImportRow {
        canon: "std.secrets",
        method: "reveal",
        import: "secrets_reveal",
        ret: ROwn,
        doc: "fresh plaintext string via wasm_alloc_str; the plan-132 audit anchor",
    },
    HostImportRow {
        canon: "std.secrets",
        method: "bearer",
        import: "secrets_bearer",
        ret: ROwn,
        doc: "fresh Secret handle via wasm_alloc_secret (bearer: payload)",
    },
    HostImportRow {
        canon: "std.secrets",
        method: "basic",
        import: "secrets_basic",
        ret: ROwn,
        doc: "fresh Secret handle via wasm_alloc_secret (basic: payload); host copies user string",
    },
    HostImportRow {
        canon: "std.secrets",
        method: "header",
        import: "secrets_header",
        ret: ROwn,
    ...
    HostImportRow {
        ...
        import: "secrets_resolve_template",
        ret: ROwn,
        doc: "fresh string via wasm_alloc_str; reveal-class template substitution",
    },
    HostImportRow {
        canon: "std.secrets",
        method: "revealOr",
        import: "secrets_reveal_or",
        ret: ROwn,
        doc: "fresh string via wasm_alloc_str; reveal-class with default fallback",
    },
    ...
    HostImportRow {
        ...
        import: "crypto_base64url_encode",
        ret: ROwn,
        doc: "fresh string via wasm_alloc_str",
    },
    HostImportRow {
        ...
        import: "crypto_base64url_decode",
        ret: ROwn,
        doc: "fresh string via wasm_alloc_str",
    },
    HostImportRow {
        canon: "std.crypto",
        method: "aesGcmEncrypt",
        import: "crypto_aes_gcm_encrypt",
        ret: ROwn,
        doc: "fresh base64 string via wasm_alloc_str",
    },
    HostImportRow {
        canon: "std.crypto",
        method: "aesGcmDecrypt",
        import: "crypto_aes_gcm_decrypt",
        ret: ROwn,
        doc: "fresh string via wasm_alloc_str",
    },
    HostImportRow {

...
pub fn std_module_exports() -> HashMap<String, Vec<(String, String)>> {
    ...
    m.insert(
        ...
        vec![
            ...
            ("bearer", "secretsBearer"),
            ("basic", "secretsBasic"),
            ("header", "secretsHeader"),
            ("refresh", "secretsRefresh"),
            ("resolveTemplate", "secretsResolveTemplate"),
            ("revealOr", "secretsRevealOr"),
        ]
        .into_iter()
        .map(|(a, b)| (a.into(), b.into()))
        .collect(),
    ...
    m.insert(
        ...
        vec![
            ...
            ("pbkdf2Sha256Hex", "cryptoPbkdf2Sha256Hex"),
            ("sha256Base64Url", "cryptoSha256Base64Url"),
            ("base64UrlEncode", "cryptoBase64UrlEncode"),
            ("base64UrlDecode", "cryptoBase64UrlDecode"),
            ("aesGcmEncrypt", "cryptoAesGcmEncrypt"),
            ("aesGcmDecrypt", "cryptoAesGcmDecrypt"),
        ]
        .into_iter()
        .map(|(a, b)| (a.into(), b.into()))
        .collect(),

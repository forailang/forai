...
impl<'a, 'c> Builder<'a, 'c> {
    ...
    pub(super) fn compile_expr(&mut self, expr: &Expression) -> Result<ValueShape, BuildError> {
        match expr {
    ...
    pub(super) fn release_stash(&mut self, stash: Option<u32>) {
        if let Some(t) = stash {
    ...
    pub(super) fn emit_string_arg_stashing(&mut self, e: &Expression) -> Result<Option<u32>, BuildError> {
    ...
    pub(super) fn compile_from_dict_value(
        &mut self,
        type_name: &str,
    ...
    pub(super) fn compile_from_dict_binding(
        &mut self,
        binding_name: &str,
        type_name: &str,
        dict_expr: Expression,
    ...
    pub(super) fn compile_query_typed_binding(
        &mut self,
        binding_name: &str,
        type_name: &str,
    ...
    pub(super) fn try_compile_move_form(
        &mut self,
        target: &str,
        value: &Expression,
    ...
    ///
    pub(super) fn compile_function_expression(&mut self, fd: &FunctionDeclaration) -> Result<(), BuildError> {
    ...
    pub(super) fn resolves_to_user_fn(&self, name: &str) -> bool {
    ...
    pub(super) fn expr_transfers_ownership(&mut self, expr: &Expression) -> bool {
